        ...
        <div style="height: 820px;" class="form-info-geral">
            ...
            <div style="width:100%;padding-left:15%;text-align: left;display: grid;grid-template-columns: auto;" class="input-wrapper">
                ...
                <div style="display: flex;align-items: center;">
                    <input class="input-checkbox-quadrado" type="checkbox" class="input-checkbox-quadrado" name="dpoc_enfisema" id="dpoc_enfisema">
                    <label style="padding-left: 5%;" for="dpoc_enfisema">Pessoa com DPOC/enfisema</label>
                </div>
                <br>
                <div style="display: flex;align-items: center;">
                    <input class="input-checkbox-quadrado" type="checkbox" class="input-checkbox-quadrado" name="cancer" id="cancer">
                    <label style="padding-left: 5%;" for="cancer">Pessoa com câncer</label>
                </div>
                <br>
                <div style="display: flex;align-items: center;">
                    <input class="input-checkbox-quadrado" type="checkbox" class="input-checkbox-quadrado" name="doenca_cronica" id="doenca_cronica">
                    <label style="padding-left: 5%;" for="doenca_cronica">Pessoa com outras doenças crônicas</label>
                </div>
                <br>
                <div style="display: flex;align-items: center;">
                    <input class="input-checkbox-quadrado" type="checkbox" class="input-checkbox-quadrado" name="hanseniase" id="hanseniase">
                    <label style="padding-left: 5%;" for="hanseniase">Pessoa com hanseníase</label>
                </div>
                <br>
                <div style="display: flex;align-items: center;">
                    <input class="input-checkbox-quadrado" type="checkbox" class="input-checkbox-quadrado" name="tuberculose" id="tuberculose">
                    <label style="padding-left: 5%;" for="tuberculose">Pessoa com tuberculose</label>
                </div>
                <br>
                <div style="display: flex;align-items: center;">
                    <input class="input-checkbox-quadrado" type="checkbox" class="input-checkbox-quadrado" name="respiratorio" id="respiratorio">
                    <label style="padding-left: 5%;" for="respiratorio">Sintomáticos respiratórios</label>
                </div>
                <br>
                <div style="display: flex;align-items: center;">
                    <input class="input-checkbox-quadrado" type="checkbox" class="input-checkbox-quadrado" name="tabagista" id="tabagista">
